Pod::Spec.new do |s|
  ...
  s.source                = { :git => "git@github.com:cognitivecreators/inpos-restkit.git", :tag => "#{s.version}" }
  s.framework             = "Foundation"
  s.requires_arc          = true
  s.default_subspec       = 'Core'
  s.swift_version         = '4.2'
  s.dependency 'InPos+Utils', '0.0.8'
  s.dependency 'InPos+Plist', '0.0.6'
  ...
  s.subspec 'CoreData' do |os|
    ...
    os.dependency 'InPos+CoreData', '0.0.16'
  end
